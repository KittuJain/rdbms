...
-- SELECT NAME FROM EMPLOYEE UNION SELECT D.DEPT_NAME, MAX(E.SALARY) AS HIGHEST_SALARY 
-- 	FROM DEPARTMENT D JOIN EMPLOYEE E ON (E.DEPT_ID=D.ID) GROUP BY (D.DEPT_NAME);